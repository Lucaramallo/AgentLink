...
_AGENT_ALIASES: dict[str, str] = {
    ...
    "orionsc": "orion-sc",
    "orion": "orion-sc",
    "orchestrator": "orion-sc",
    "lexlegal": "lex-legal",
    "lex": "lex-legal",
    "legal": "lex-legal",
    "agilepm": "agile-pm",
    "pm": "agile-pm",
    "projectmanager": "agile-pm",
    "echocopy": "echo-copy",
    "echo": "echo-copy",
    "copy": "echo-copy",
    "copywriter": "echo-copy",
    "atlasresearch": "atlas-research",
    "atlas": "atlas-research",
    "research": "atlas-research",
    "chaindefi": "chain-defi",
    "chain": "chain-defi",
    "defi": "chain-defi",
    "blockchain": "chain-defi",
    "pixelmobile": "pixel-mobile",
    "pixel": "pixel-mobile",
    "mobile": "pixel-mobile",
    "schemadb": "schema-db",
    "schema": "schema-db",
    ...
    "designer": "canvas-design",
    "viralgrowth": "viral-growth",
    "viral": "viral-growth",
    "growth": "viral-growth",
    "fluxdata": "flux-data",
    "flux": "flux-data",
    "dataengineer": "flux-data",
    "docstw": "docs-tw",
    "docs": "docs-tw",
    "tw": "docs-tw",
    ...
    "pulse": "pulse-health",
    "health": "pulse-health",
    "biotech": "pulse-health",
    "ledgercfo": "ledger-cfo",
    "ledger": "ledger-cfo",
    "cfo": "ledger-cfo",
    "talenthr": "talent-hr",
    "talent": "talent-hr",
